...
class FacultiesControllerTest < ActionController::TestCase
  ...
  test "should create faculty" do
    assert_difference('Faculty.count') do
      post :create, faculty: { abstract: @faculty.abstract, abstract: @faculty.abstract, code: @faculty.code, name: @faculty.name }
    end
  ...
  test "should update faculty" do
    patch :update, id: @faculty, faculty: { abstract: @faculty.abstract, abstract: @faculty.abstract, code: @faculty.code, name: @faculty.name }
    assert_redirected_to faculty_path(assigns(:faculty))
  end
